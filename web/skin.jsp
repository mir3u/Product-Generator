...
<%@page import="controllers.SkinDAO"%>
...
<head>
    ...
    <title>Complexion Products</title>
    ...
    <div class="container main-container">
        <div class="col-md-6">
            <% 
                ...
                List<Products> prods= SkinDAO.getInstance().getProducts(user1);
            ...
            %>
            <div class="col-md-6 ">
                    <a href="view1.jsp?id=<%out.println(id);%>" title="View Product" class="portfolio_item">
                        <img src="img/<%out.println( prod.getImage());%>.jpg" alt="image" class="img-responsive" />
                        <div class="portfolio_item_hover">
                            <div class="portfolio-border clearfix">
                                <div class="item_info">
                                    <span><%out.println(prod.getName());%></span>
                                    <em>See more</em>
                                </div>
                            </div>
                        </div>
...
<!--                <tr>
                <td><%out.println(prod.getName());%></td>
                <td><%out.println(prod.getDescription());%></td>
                <td><%out.println(prod.getRating());%></td>
                  <% } %>  -->
                </tr>
<!--                <c:forEach var="i" begin = "0" end = "${dates.size()-1}" step="2">-->
